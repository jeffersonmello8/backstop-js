const baseUrl = "http://npisistemas.com.br"; // Replace the value "http://example.com" by the base URL of the website you want to test.
const projectId = "npi_testes_visuais"; // Replace the value "sample project" by the id of your project. It can be any string (e.g., "my-website").
